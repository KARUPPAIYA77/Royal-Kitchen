...
<body class="bg-light">
			...
			<div class="accordion" id="contactAccordion">
				<div class="card">
					...
					<div id="collapseContact" class="collapse show"
						...
						<div class="card-body">
							<p>
								Email: karuppaiya983@gmail.com
							</p>
							<p>Phone: 9025709399</p>
							<p>
								LinkedIn: <a
									href="https://www.linkedin.com/in/karuppaiya-m?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
									target="_blank">https://www.linkedin.com/in/karuppaiya-m/</a>
							</p>
							<p>
								Instagram <a href="https://www.instagram.com/paiya.07/"
									target="_blank">https://www.instagram.com/paiya.07/</a>
							</p>
							<p>Availability: Contact via Email</p>
						</div>
					</div>
				</div>
			</div>
	...
	<footer class="text-center py-2 fixed-bottom"
		...
		<p class="mt-2">Designed and developed by @Karuppaiya</p>
	</footer>
