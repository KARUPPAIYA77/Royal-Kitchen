...
<body>
    <div class="container">
        ...
        <%
            ...
            if (username != null && email != null && phone != null && password != null && address != null) {
                // Process the form data (you can save it to the database here)
                // You can print the data to the console for testing purposes:
                ...
                // Here, you can add the logic to store the data in a database or perform other actions.
                // After successful form processing, redirect to the home page:
                response.sendRedirect("Home.jsp");  // Change "home.jsp" to the actual page path you want to redirect to
                return; // Exit after redirect to prevent further processing
            }
        %>
